...
if (Username.equals("Admin") && Password.equals("Adm1n1strat0r"))
{
...
try{   
 ...
 String query ="Select USERNAME, PASSWORD from players where USERNAME='"+Username+"'";
   ...
   if(rs.next()) 
   {
    {if(Password.equals(rs.getString("PASSWORD"))){
         ...
         new PLAYER_SCREEN().setVisible(true);
          String query2 ="Select FIRSTNAME, SURNAME from players where USERNAME  ='"+Username+"'";
          pst=conn.prepareStatement(query2); 
          rs=pst.executeQuery();
          if(rs.next())
          {
          PLAYER_SCREEN.jLabel1.setText("Hello "+ rs.getString("FIRSTNAME")+" "+ rs.getString("SURNAME") +"! What would you like to do?");
          dispose();
          }
    }
